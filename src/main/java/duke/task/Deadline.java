...
/**
 * Represents a Deadline input by user. Identified by 'deadline' header and '\by'. Inherits Task class.
 */
public class Deadline extends Task {
     ...
     * @param deadline        String after the '\by' in the user input. Represents time that deadline should be done
     *                        by.
     */
