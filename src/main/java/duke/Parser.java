...
public class Parser {
    ...
    public static void parse() throws DukeException {
        ...
        do {
            ...
            case FIND:
               //todo quickzzz
                break;
            default:
                //todo change print method to String type?
//                throw new DukeException(Ui.printWrongTaskType(taskName, taskType));
                Ui.showWrongTaskTypeError(taskType + " " + taskName);
                break;
            }
        } while (!isExit);
    }
...
//todo should I use parse methods, since they are meaningless one-liners?
    ...
    private static void parseFind() {

    }

    protected static String parseDefault(String taskName, String taskType) {
