...
public class Shika {
     ...
     */
    public static void setupShika() throws FileNotFoundException {
        File f = new File("data/ShikaTasks.txt");
        String greeting = (setupSave(f)) ? "Hello, friend! " : "Welcome back, friend! ";
    ...
    /**
     * This function setups Shika, then runs Shika.
     */
    public static void startShika() {
        try {
            setupShika();
