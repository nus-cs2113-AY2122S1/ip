public class DukeException extends Exception {
    ...
    protected static final String TASK_INDEX_INVALID = "Index of task is not a valid integer.";
    protected static final String COMMAND_INVALID = "Command given cannot be recognized.";
